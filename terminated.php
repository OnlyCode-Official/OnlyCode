...
<head>
    ...
    <title>Account Terminated · OnlyGit</title>
    <style>
            body {
...
<body>
    <div class='center'>
        ...
        <p class='text'>Your OnlyGit account has been terminated due to a violation of our terms of service. Sorry for the inconvenience.</p><br><br><br><br>
    </div>
</body>
</html>